...
//
//
//class TimingOutDatabaseSpec extends Specification with JMocker with ClassMocker with PendingUntilFixed {
...
//    }
//
//    val timingOutDatabase = new TimingOutDatabase(database, "driver", "dbname", 1, 1, timeout, timeout, 1)
//    shouldWait = true
//
//    "timeout" in {
//      try {
